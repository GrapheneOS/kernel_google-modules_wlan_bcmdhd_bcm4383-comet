...
#define EPI_VERSION		103, 102, 19, 3

#define EPI_VERSION_NUM		0x67661303

#define EPI_VERSION_DEV		103.102.19

/* Driver Version String, ASCII, 32 chars max */
#if defined (WLTEST)
#define EPI_VERSION_STR		"103.102.19.3 (wlan=r1060900 WLTEST)"
#elif (defined (BCMDBG_ASSERT) && \
	!defined (BCMDBG_ASSERT_DISABLED) && \
	!defined (ASSERT_FP_DISABLE))
#define EPI_VERSION_STR		"103.102.19.3 (wlan=r1060900 ASSRT)"
#else
#define EPI_VERSION_STR		"103.102.19.3 (wlan=r1060900)"
#endif /* BCMINTERNAL */
